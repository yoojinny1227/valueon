...
var mailbox = _interopRequireWildcard(require("./mailbox.js"));
...
/** @internal */
const asyncPush = (register, options) => Effect.acquireRelease(mailboxFromBufferOptionsPush(options), mailbox => mailbox.shutdown).pipe(Effect.tap(mailbox => register(emit.makePush(mailbox))), Effect.map(mailboxToStream), unwrapScoped);
/** @internal */
...
const mailboxToStream = self => fromChannel(mailbox.toChannel(self));
/** @internal */
exports.mailboxToStream = mailboxToStream;
const mailboxFromStream = exports.mailboxFromStream = /*#__PURE__*/(0, _Function.dual)(args => isStream(args[0]), (self, options) => effectCore.tap(fiberRuntime.acquireRelease(mailbox.make(options), mailbox => mailbox.shutdown), mailbox => {
